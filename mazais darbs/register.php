...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $today = new DateTime();  // Izmanto DateTime objektu, lai veiktu salīdzinājumu
    ...
    try {
        ...
        // Pāradresē uz login lapu pēc veiksmīgas reģistrācijas
        header("Location: index.php");
        exit();
    } catch (PDOException $e) {
        echo "<p style='color: red;'>Radās kļūda: " . $e->getMessage() . "</p>";
    }
}
?>
